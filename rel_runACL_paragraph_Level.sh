...
./run_bi-lstm-cnn-crf3.sh ${data}/train_rel_r.txt ${data}/dev_rel_r.txt ${data}/test_rel_r.txt ${embeddings} /home/fzuir/czz/acl2017-neural_end2end_am-master/data/outputs_ACL/MODELS/sub_paragraph_rel${i}.mod 200 > ${ouputPath}/paragraph_rel_100d200_${i}.dat
done
