...
./run_bi-lstm-cnn-crf3.sh ${data}/train_comp_c.txt ${data}/dev_comp_c.txt ${data}/test_comp_c.txt ${embeddings} /home/fzuir/czz/acl2017-neural_end2end_am-master/data/outputs_ACL/MODELS/sub_paragraph_comp${i}.mod 200 > ${ouputPath}/paragraph_comp_100d200_${i}.dat
done
