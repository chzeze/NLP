...
data=/home/fzuir/czz/acl2017-neural_end2end_am-master/data/conll/Essay_Level/
nunits=200
...
./run_bi-lstm-cnn-crf3.sh ${data}/train.dat ${data}/dev.dat ${data}/test.dat ${embeddings} /home/fzuir/czz/acl2017-neural_end2end_am-master/data/outputs_ACL/MODELS/sub_essay${i}.mod 200 > ${ouputPath}/sub_essay100d200_${i}.dat
done
