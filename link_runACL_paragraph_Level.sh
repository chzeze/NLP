...
./run_bi-lstm-cnn-crf3.sh ${data}/train_Link.txt ${data}/dev_Link.txt ${data}/test_Link.txt ${embeddings} /home/fzuir/czz/acl2017-neural_end2end_am-master/data/outputs_ACL/MODELS/sub_paragraph_link${i}.mod 200 > ${ouputPath}/paragraph_link_100d200_${i}.dat
done
