...
for i in 0 ; do 
./run_bi-lstm-cnn-crf3.sh ${data}/train.dat ${data}/dev.dat ${data}/test.dat ${embeddings} /home/fzuir/czz/acl2017-neural_end2end_am-master/data/outputs_ACL/MODELS/sub_paragraph${i}.mod 200 > ${ouputPath}/paragraph100d200${i}.dat
done
