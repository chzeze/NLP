...
./run_bi-lstm-cnn-crf3.sh ${data}/train_BIO.txt ${data}/dev_BIO.txt ${data}/test_BIO.txt ${embeddings} /home/fzuir/czz/acl2017-neural_end2end_am-master/data/outputs_ACL/MODELS/sub_paragraph_bio${i}.mod 200 > ${ouputPath}/paragraph_bio_100d200_${i}.dat
done
