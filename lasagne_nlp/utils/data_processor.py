...
MAX_LENGTH_TRAIN = 0
MAX_LENGTH_DEV = 0
global MAX_LENGTH_DEV
global MAX_LENGTH_TRAIN
global MY_MAX_LENGTH
MY_MAX_LENGTH = 0
...
def generate_character_data(sentences_train, sentences_dev, sentences_test, sentences_real_test, max_sent_length, char_embedd_dim=30):
    """
    ...
    index_sentences_real_test, max_char_length_real_test = get_character_indexes(sentences_real_test)
    ...
    C_real_test = construct_tensor_char(index_sentences_real_test)

    return C_train, C_dev, C_test, C_real_test, build_char_embedd_table()
...
def load_dataset_sequence_labeling(train_path, dev_path, test_path, real_test_path, word_column=1, label_column=4,
    ...
    def generate_dataset_fine_tune():
        ...
        X_real_test, Y_real_test, mask_real_test = construct_tensor_fine_tune(word_index_sentences_real_test, label_index_sentences_real_test)
        C_train, C_dev, C_test, C_real_test, char_embedd_table = generate_character_data(word_sentences_train, word_sentences_dev,
                                                                                         word_sentences_test, word_sentences_real_test, 
                                                                            max_length) if use_character else (
            None, None, None, None)
        return X_train, Y_train, mask_train, X_dev, Y_dev, mask_dev, X_test, Y_test, mask_test, X_real_test, Y_real_test, mask_real_test, \
               build_embedd_table(word_alphabet, embedd_dict, embedd_dim, caseless), label_alphabet, word_alphabet, \
               C_train, C_dev, C_test, C_real_test, char_embedd_table
    ...
    def generate_dataset_not_fine_tune():
        ...
        X_test, Y_test, mask_test = construct_tensor_not_fine_tune(word_sentences_test, label_index_sentences_test,
                                                                   unknown_embedd, embedd_dict, embedd_dim, caseless)
        X_real_test, Y_real_test, mask_real_test = construct_tensor_not_fine_tune(word_sentences_real_test, label_index_sentences_real_test,
                                                                                  unknown_embedd, embedd_dict, embedd_dim, caseless)
        ...
        return X_train, Y_train, mask_train, X_dev, Y_dev, mask_dev, X_test, Y_test, mask_test, X_real_test, Y_real_test, mask_real_test, \
               None, label_alphabet, word_alphabet, C_train, C_dev, C_test, char_embedd_table
    ...
    if real_test_path:
        word_sentences_real_test, _, word_index_sentences_real_test, label_index_sentences_real_test = read_conll_sequence_labeling(
                    real_test_path, word_alphabet, label_alphabet, word_column, label_column)
    ...
    max_length_real_test = get_max_length(word_sentences_real_test)
    max_length = min(MAX_LENGTH, max(max_length_train, max_length_dev, max_length_test, max_length_real_test))
    global MAX_LENGTH_TRAIN
    MAX_LENGTH_TRAIN = max_length_train
    global MAX_LENGTH_DEV
    print "XXXXXXXXXXX",MAX_LENGTH_DEV
    MAX_LENGTH_DEV = max_length_dev
    print "ZZZZZZZZZZZ",MAX_LENGTH_DEV
...
def load_dataset_parsing(train_path, dev_path, test_path, real_tes_path, word_column=1, pos_column=4, head_column=6, type_column=7,
    ...
    word_sentences_real_test, pos_sentences_real_test, head_sentences_real_test, type_sentence_real_test, \
    word_index_sentences_real_test, pos_index_sentences_real_test, \
    type_index_sentences_real_test = read_conll_parsing(real_test_path, word_alphabet, pos_alphabet, type_alphabet, word_column,
                                                   pos_column, head_column, type_column)
    ...
    global MY_MAX_LENGTH
    MY_MAX_LENGTH = max_length
    logger.info("MY_MAX_LENGTH set to %d" %MY_MAX_LENGTH)
    ...
    X_real_test, POS_real_test, Head_real_test, Type_real_test, mask_real_test = construct_tensor(word_index_sentences_real_test,
                                                                         pos_index_sentences_real_test,
                                                                         head_sentences_real_test,
                                                                         type_index_sentences_real_test)
    

    embedd_table = build_embedd_table(word_alphabet, embedd_dict, embedd_dim, caseless)

    C_train, C_dev, C_test, C_real_test, char_embedd_table = generate_character_data(word_sentences_train, word_sentences_dev,
                                                                        word_sentences_test, word_sentences_real_test, max_length)

    return X_train, POS_train, Head_train, Type_train, mask_train, \
           X_dev, POS_dev, Head_dev, Type_dev, mask_dev, \
           X_test, POS_test, Head_test, Type_test, mask_test, \
           X_real_test, POS_real_test, Head_real_test, Type_real_test, mask_real_test, \
